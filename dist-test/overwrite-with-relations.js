...
import { Graph, Relation, Triple, Id } from "@graphprotocol/grc-20";
...
async function overwriteWithRelations() {
    try {
        ...
        const { buyerRelationTypeId, sellerRelationTypeId, documentTypeRelationTypeId, personTypeId, documentTypeTypeId, nameAttributeId } = await createRelationTypes(ops);
