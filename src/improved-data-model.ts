 ...
 */
export async function createDeedProperties(deedTypeId: string): Promise<{
  ops: Op[];
 ...
 * @returns Array of operations and IDs for the created properties
 */
export async function createPermitProperties(permitTypeId: string): Promise<{
  ops: Op[];
 ...
 */
export async function createDocumentTypeEntities(documentTypeTypeId: string): Promise<{
  ops: Op[];
 ...
 */
export async function createRecordTypeEntities(recordTypeTypeId: string): Promise<{
  ops: Op[];
 ...
 */
export async function createStatusEntities(statusTypeId: string): Promise<{
  ops: Op[];
