// update-entity-ids-in-triples.cjs
const fs = require('fs');
 ...
 */
function updateEntityIdsInTriples() {
  try {
    ...
    fs.writeFileSync('data/deeds-triples-updated.json', JSON.stringify(updatedDeedsTriples, null, 2));
